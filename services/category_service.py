...
def create_category_group(user_id: int, name: str, type: str):
    ...
    group_id = categories_q.create_category_group(user_id=user_id, name=name, type=type, is_system=False)
...
def update_category_group(group_id: int, name: str | None = None, type: str | None = None, is_active: bool | None = None):
    group = categories_q.get_category_group(group_id)
    if group is None:
        raise ValueError("Category group does not exist")
...
def update_category(category_id: int, name: str | None = None, is_active: bool | None = None):
